...
_TRAININGINSTANCEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='classlist_locations', full_name='TrainingInstanceInfo.classlist_locations', index=2,
